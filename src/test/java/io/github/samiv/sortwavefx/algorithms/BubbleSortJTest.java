...
public class BubbleSortJTest {
    ...
    public void testSortActionSequence() {
        ...
        */
        ...
        assertEquals(14, step3.accessCount());
        assertEquals(3, step3.comparisonCount());
        assertEquals(2, step3.swapCount());

        // Step 4: The sort is finished, hence, next step should set the isDone flag to true, and the sortAction null.
        SortAction step4 = bubbleSort.step();
